...
var mongoose = require('mongoose'),
	...
	_ = require('lodash'),
    scrapedData = require('./SalaryScraperExports');
...
//    var template = {};
//
//    template.name = scrapedData[i][0];
//    template.position = scrapedData[i][1];
//    template.department = scrapedData[i][2];
//    template.grossCompensation = scrapedData[i][3];
//
//    var employee = new Employee(template);
//
////    employee.save(function(err) {
////        if (err) {
////            return err;
